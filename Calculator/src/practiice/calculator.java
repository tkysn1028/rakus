...
List<String> list;
	...
	public	calculator(){
		...
		list = new ArrayList<String>();
			...
			JButton btplmin = new JButton("out");
			gbc.gridx = 1;
			gbc.gridy = 1;
			layout.setConstraints(btplmin, gbc);
			p.add(btplmin);
			btplmin.setPreferredSize(new Dimension(60,60));
			btplmin.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
			Fileoutput.Fileout(list);
				}
			});
...
btdiv.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					if(ari.getFstoprnd() != null && ari.getScdoprnd() != null) {
						...
						list.add(String.valueOf(ari.getResult()));
						label1.setText(sb.toString());
						ari.deleteOp();
						
					}
					list.add(btdiv.getText());
